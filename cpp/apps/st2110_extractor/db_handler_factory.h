...
namespace ebu_list::st2110_extractor
{
    class db_handler_factory : public analysis::abstract_handler_factory
    {
      public:
        ...
        create_c_inst_histogram_logger(const std::string& stream_id) const override;
        ...
        create_audio_tsdf_logger(const std::string& pcap_id, const std::string& stream_id,
                                 const std::string& prefix) const override;
        analysis::anc_stream_handler::listener_uptr
        create_anc_rtp_logger(const std::string& pcap_id, const std::string& stream_id,
                                 const std::string& prefix) const override;
