...
{
    template<class Header, class MessageBody, class MessageLens>
    class base_message
    {
    ...
    public:
        ...
        const MessageLens& message() const noexcept
        {
            return message_lens_;
        }

        clock::time_point packet_timestamp() const
        {
