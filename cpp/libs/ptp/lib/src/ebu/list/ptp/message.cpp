...
{
    int64_t i = static_cast<int64_t>(raw[0]) << 40 | static_cast<int64_t>(raw[1]) << 32 |
                static_cast<int64_t>(raw[2]) << 24 | static_cast<int64_t>(raw[3]) << 16 |
                static_cast<int64_t>(raw[4]) << 8 | static_cast<int64_t>(raw[5]);

    int64_t f = static_cast<int64_t>(raw[6]) << 24 | static_cast<int64_t>(raw[7]) << 16 |
                static_cast<int64_t>(raw[8]) << 8 | static_cast<int64_t>(raw[9]);
