...
namespace data
{
    ...
    namespace two_step_sequence_1
    {
        ...
        constexpr auto sync = to_byte_array(
        ...
        constexpr auto sync_with_timestamp = to_byte_array(
            0x00, 0x02, 0x00, 0x2c, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x28, 0x99, 0x3a, 0xff, 0xff, 0x26, 0x7e, 0x2b, 0x00, 0x14, 0xb3, 0xc3,
            0x00, 0xfd, 0x00, 0x00, 0x58, 0x9b, 0x33, 0x14, 0x39, 0xd8, 0x97, 0xbe
        );

        constexpr auto follow_up_ts = clock::time_point(std::chrono::nanoseconds(1486566127'770212129));
        constexpr auto follow_up = to_byte_array(
        ...
        constexpr auto delay_req = to_byte_array(
