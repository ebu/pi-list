...
namespace ebu_list::rtp::test
{
    namespace header_1
    {
        ...
        constexpr auto data =
            to_byte_array(0x82, 0x3f, 0xe9, 0xe2, 0xa1, 0x10, 0x78, 0xb9, 0x13, 0x1b, 0x69, 0x7c, // header
    ...
    namespace header_with_extension
    {
        ...
        constexpr auto data =
            to_byte_array(0x90, 0xe7, 0xda, 0xc8, 0x9a, 0xf8, 0x36, 0x00, 0x47, 0x10, 0x9c, 0x42, // header
