...
multicast_subscription::multicast_subscription(const ipv4::address listen_address, ipv4::address multicast_address,
                                               port multicast_port)
...
multicast_subscriber::multicast_subscriber(ipv4::address listen_address) : listen_address_(listen_address)
{
}
...
void multicast_subscriber::subscribe_to(ipv4::address address, port port)
{
    ...
    auto subscription = std::make_unique<multicast_subscription>(listen_address_, address, port);
