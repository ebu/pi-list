...
namespace ebu_list::media::anc
{
    ...
    const std::vector<stream_type> stream_types{
        ...
        {"Stereoscopic 3D Frame Compatible Packing and Signaling (ST 2068)",
         did_sdid::STEREOSCOPIC_3D_FRAME_COMPATIBLE_PACKING_AND_SIGNALING},
        {"Lip Sync data (ST 2064)", did_sdid::LIP_SYNC_DATA},
        {"Structure of inter-station control data conveyed by ancillary data packets (ITU-R BT.1685)",
         did_sdid::STRUCTURE_OF_INTER_STATION_CONTROL_DATA},
        {"Subtitling Distribution packet (SDP) (RDD 8)", did_sdid::SUBTITLING_DISTRIBUTION_PACKET},
        {"Transport of ANC packet in an ANC Multipacket (RDD 8)",
         did_sdid::TRANSPORT_OF_ANC_PACKET_IN_AN_ANC_MULTIPACKET},
        {"Metadata to monitor errors of audio and video signals on a broadcasting chain ARIB",
         did_sdid::ARIB_ERROR_MONITOR},
        {"Acquisition Metadata Sets for Video Camera Parameters (RDD18)",
         did_sdid::ACQUISITION_METADATA_SETS_FOR_VIDEO_CAMERA_PARAMETERS},
        ...
        {"Packing UMID and Program Identification Label Data into SMPTE 291M Ancillary Data Packets (RP223)",
         did_sdid::PACKING_UMID_AND_PROGRAM_IDENTIFICATION},
        ...
        {"Time Code in HANC space (Deprecated; for reference only) (RP196 (Withdrawn))",
         did_sdid::TIME_CODE_IN_HANC_SPACE},
