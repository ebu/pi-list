...
{
    if( s== "BT601") return colorimetry::BT601;
    else if( s== "BT709") return colorimetry::BT709;
    else if( s== "BT2020") return colorimetry::BT2020;
    else if( s== "BT2100") return colorimetry::BT2100;
    else if( s== "ST2065-1") return colorimetry::ST2065;
    else if( s== "ST2065-3") return colorimetry::ST2063;
    else if( s== "XYZ") return colorimetry::XYZ;
    else return colorimetry ::UNKNOWN;
}
...
{
    if( s== "YCbCr-4:2:0") return video_sampling::YCbCr_4_2_0;
    else if( s== "YCbCr-4:2:2") return video_sampling::YCbCr_4_2_2;
    else if( s== "YCbCr-4:4:4") return video_sampling::YCbCr_4_4_4;
    else if( s== "RGB") return video_sampling::RGB_4_4_4;
    else if( s== "XYZ") return video_sampling::XYZ_4_4_4;
    else return video_sampling::UNKNOWN;
}
