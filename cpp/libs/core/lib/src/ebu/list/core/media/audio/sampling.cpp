...
{
    if( s == "44100" ) return audio_sampling::_44_1kHz;
    else if( s == "48000" ) return audio_sampling::_48kHz;
    else if( s == "96000" ) return audio_sampling::_96kHz;
    else return audio_sampling::UNKNOWN;
}
...
{
    if( s == "L24" ) return audio_encoding::L24;
    else if( s == "L16" ) return audio_encoding::L16;
    else return audio_encoding::UNKNOWN;
}
