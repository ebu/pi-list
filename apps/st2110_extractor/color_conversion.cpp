...
oview ebu_list::from_ycbcr422_to_rgba(oview ycbcr422, media::video::video_dimensions dimensions)
{
...
oview ebu_list::from_ycbcr422_to_uyvy(oview ycbcr422, media::video::video_dimensions dimensions)
{
    const auto width = dimensions.width;
    const auto height = dimensions.height;
