...
export const getAudioCursor = (mp3Duration: number, mp3CurrentTime: number, audioInfo: any) => {
    ...
    const rawDuration: number =
        (audioInfo.statistics.last_packet_ts - audioInfo.statistics.first_packet_ts) / nsPerSec +
    ...
    const cursorTsS: number = mp3CurrentTime - mp3RawError + audioInfo.statistics.first_packet_ts / nsPerSec;
    ...
    return list.stream
        ...
        .then(e => {
            const deltaPktVsRtp = e.length > 0 ? e[0].value / usPerSec : NaN; // e in us
            return {
                pktTs: cursorTsS,
