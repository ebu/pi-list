...
const UploadModal = ({ isOpen, onUploadDone, onModalClose, receivedFiles }: IComponentProps) => {
    ...
    const onUpload = () => {
        filesToAnalyze.map(file => {
            list.pcap.patch(file.pcap_id, { sdps: file.sdps, transport_type: file.transport_type }).catch(err => {
    ...
    return (
        <div id="main">
            ...
            >
                ...
                <div className="pcap-modal-parent-scroll-container">
                    <CustomScrollbar>
                        <div className="pcap-modal-input-container">
                            {receivedFiles.map((receivedFile: any) => {
                                return (
                                    <PcapUploadInformation
                                        key={receivedFile.pcap_id}
                                        receivedPcap={receivedFile}
                                        patchPcap={patchPcap}
